...
<body>
        ...
        <table>
			<h2 align="center">Program Approve List</h2>
		...
		?>		
			<td align="center"><a href ="viewApprove_ReportList.php?no=<?=$row['program_name']?>">View</a>
		...
		{
			echo "<tr><td colspan='5' align='center'>No Approve Program</td></tr>";
		}
			?>
