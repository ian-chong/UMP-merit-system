...
$total11=0;
$total12=0;
$result="SELECT count(pro_id) as i, MONTH(programS_date) as month  from report_parmerit where program_status='Disapprove' and YEAR(programS_date)='$yr' group by month";
$rr=mysqli_query($link, $result) or die("Error: " . mysqli_error($link));
	...
	function drawChart()
	 {
      ...
      var options =
       {title: "Total number of Reject program in every month <?php echo $yr?>",width: 600,height: 400,bar: {groupWidth: "95%"},legend: { position: "none" }};
      ...
      google.charts.setOnLoadCallback(drawChart1);
        ...
        var options = {
          title: 'Percentage Of Reject Program in every month <?php echo $yr?>',
          is3D: true,
        };
