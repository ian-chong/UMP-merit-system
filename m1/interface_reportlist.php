...
<body>
        ...
        <table>
			<h2 align="center">Program In Pending List</h2>
		...
		?>		
			<td align="center"><a href ="viewPending_ReportList.php?no=<?=$row['program_name']?>">View</a>
		...
		{
			echo "<tr><td colspan='5' align='center'>No In Pending Program</td></tr>";
		}
			?>
