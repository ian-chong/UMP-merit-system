...
$query = "SELECT date,count(*)as number FROM attendance GROUP BY date";
$result = mysqli_query($connect,$query);
?>
<!DOCTYPE html>
<html>
	<head>
		<title>Attendance Report of Committee Members based on Date </title>
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Date Attendance Report of Committee Members'
        };
