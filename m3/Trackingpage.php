...
<body>
	...
	<tr>
		<td colspan="2">
			<button type="button" class="button button1" onclick="window.location.href='eventd.php'">Participant Merit Details and Attendance</button>
		</td>
	</tr>
	<tr>
		<td><button type="button" class="button button2" onclick="window.location.href='CommitteAttendance.php'">Committee Attendance</button></td>
	</tr>
