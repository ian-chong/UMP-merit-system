...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2020 at 09:14 PM
...
(9, 'Crazy Run', 'test', 'test', 100, 'test', '7837729742', 'ump', '2020-08-05', '2020-08-06', '', '', 0, 'dfssffs.jpg', 'Disapprove'),
(10, 'BasketBall', 'test', 'test', 100, 'test', '7837729742', 'ump', '2020-08-05', '2020-08-06', '', '', 0, 'dfssffs.jpg', 'Approve');
...
--
ALTER TABLE `report_parmerit`
  MODIFY `pro_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
