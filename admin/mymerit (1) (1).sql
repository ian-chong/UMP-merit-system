...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2020 at 09:15 AM
...
INSERT INTO `comm_detail` (`id`, `program_name`, `comm_no`, `std_id`, `std_name`, `std_phone`, `std_position`, `comm_merit`) VALUES
(9, 'kk', 2, 'cy777777', 'fefe', '0123456789', 'main_committee', 300),
(10, 'kk', 2, 'ca18101', 'hoh hong quan', '0123456789', 'sub_committee', 200),
(11, 'basketball 3 on 3', 2, 'cy777777', 'fefe', '0123456789', 'program_chair', 500),
(12, 'basketball 3 on 3', 2, 'ca18101', 'hoh hong quan', '0123456789', 'program_cochair', 450);
...
(7, 'kk', 'll', 'yy', 6, 'gg', '0123456789', 'hh', '2020-07-30', '2020-07-30', '0700', '1800', 100, 'layout.pptx', 'In Pending'),
(8, 'basketball 3 on 3', 'EBUMP', 'Dr. Lee', 10, 'gg', '0123456789', 'hh', '2020-08-01', '2020-08-01', '0700', '1800', 100, 'layout.pptx', 'In Pending');
